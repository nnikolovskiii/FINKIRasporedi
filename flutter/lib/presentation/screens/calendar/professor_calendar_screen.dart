...
class ProfessorCalendarScreen extends StatefulWidget {
  ...
  @override
  _ProfessorCalendarScreenState createState() => _ProfessorCalendarScreenState();
}
...
class _ProfessorCalendarScreenState extends State<ProfessorCalendarScreen> {
  ...
  Future<void> _loadData() async {
    professorId = Provider.of<ScheduleProvider>(context, listen: false).professor;
    Schedule schedule = await scheduleService.getScheduleByProfessor(professorId);
